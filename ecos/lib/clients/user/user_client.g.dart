...
class _UserClient implements UserClient {
  ...
  Future<BaseInformation> register({
    ...
    final _options = _setStreamType<BaseInformation>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
    ...
    late BaseInformation _value;
    try {
      _value = BaseInformation.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<User> getAccountInformation({required String token}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
